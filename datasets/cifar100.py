...
class CIFAR100(object):
    ...
    def __init__(self, batch_size=128, num_workers=4):
        ...
        train_dataset = torchvision.datasets.CIFAR100(root='./datasets/data',
            train=True, download=True, transform=train_transform)
        test_dataset = torchvision.datasets.CIFAR100(root='./datasets/data',
...
class CIFAR100Val(object):
    ...
    def __init__(self, batch_size=128, num_workers=4, val_size=5000):
        ...
        train_dataset = torchvision.datasets.CIFAR100(root='./datasets/data',
            train=True, download=True, transform=train_transform)
        val_dataset = torchvision.datasets.CIFAR100(root='./datasets/data',
